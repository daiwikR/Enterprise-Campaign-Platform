    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table => table.PrimaryKey("PK_LoyaltyPrograms", x => x.ProgramId));
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CampaignEvents", x => x.EventId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MultiplierBonus = table.Column<decimal>(type: "decimal(5,2)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LoyaltyTiers", x => x.TierId);
                    table.ForeignKey(
                        name: "FK_LoyaltyTiers_LoyaltyPrograms_ProgramId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LoyaltyTransactions_Campaigns_CampaignId",
                        column: x => x.CampaignId,
                        principalTable: "Campaigns",
                        principalColumn: "CampaignId",
                        onDelete: ReferentialAction.Restrict);
            ...
            // Campaign indexes
            migrationBuilder.CreateIndex(name: "IX_Campaigns_Status",         table: "Campaigns", column: "Status");
            migrationBuilder.CreateIndex(name: "IX_Campaigns_StartDate",      table: "Campaigns", column: "StartDate");
            migrationBuilder.CreateIndex(name: "IX_Campaigns_CreatedByUserId",table: "Campaigns", column: "CreatedByUserId");

            // CampaignEvent indexes
            migrationBuilder.CreateIndex(name: "IX_CampaignEvents_CampaignId", table: "CampaignEvents", column: "CampaignId");
            migrationBuilder.CreateIndex(name: "IX_CampaignEvents_OccurredAt", table: "CampaignEvents", column: "OccurredAt");
            migrationBuilder.CreateIndex(name: "IX_CampaignEvents_EventType",  table: "CampaignEvents", column: "EventType");

            // LoyaltyTier indexes
            migrationBuilder.CreateIndex(name: "IX_LoyaltyTiers_ProgramId", table: "LoyaltyTiers", column: "ProgramId");

            // LoyaltyTransaction indexes
            migrationBuilder.CreateIndex(name: "IX_LoyaltyTransactions_UserId",          table: "LoyaltyTransactions", column: "UserId");
            migrationBuilder.CreateIndex(name: "IX_LoyaltyTransactions_CampaignId",      table: "LoyaltyTransactions", column: "CampaignId");
            migrationBuilder.CreateIndex(name: "IX_LoyaltyTransactions_TransactionDate", table: "LoyaltyTransactions", column: "TransactionDate");
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "LoyaltyTiers");
